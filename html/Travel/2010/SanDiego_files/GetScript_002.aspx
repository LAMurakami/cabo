...
{    
    ShowPopup(idOfContentDiv, xOffset, yOffset, "FALSE", "FALSE", "FALSE");
}
function ShowPopupDiv2(idOfContentDiv, anchorItem, xOffset, yOffset)
{
	var posofAnchorItem = GetObjectPosition(anchorItem);
    ShowPopup(idOfContentDiv, xOffset , posofAnchorItem.y + yOffset - 250, "FALSE", "FALSE", "FALSE");
}
function ShowPopupDivHideTopCloseButton(idOfContentDiv, xOffset, yOffset)
{    
    ShowPopup(idOfContentDiv, xOffset, yOffset, "FALSE", "TRUE", "FALSE");
}
function ShowPopupDivHideTopBottomCloseButton(idOfContentDiv, xOffset, yOffset)
{
	ShowPopup(idOfContentDiv, xOffset, yOffset, "FALSE", "TRUE", "TRUE");
}

function ShowPopupURL(anchorItem, xOffset, yOffset)
{
    var url = anchorItem.href;
    ShowPopup(url, xOffset, yOffset, "TRUE", "FALSE", "FALSE");
}
function ShowPopupURL2(anchorItem, xOffset, yOffset)
{
    var url = anchorItem.href;
    var posofAnchorItem = GetObjectPosition(anchorItem);
    ShowPopup(url, xOffset, posofAnchorItem.y + yOffset, "TRUE", "FALSE", "FALSE");
}
function ShowPopupURLHideTopCloseButton(anchorItem, xOffset, yOffset)
{
    var url = anchorItem.href;
    ShowPopup(url, xOffset, yOffset, "TRUE", "TRUE", "FALSE");
}

function ShowPopupURLHideTopBottomCloseButton(anchorItem, xOffset, yOffset)
{
    var url = anchorItem.href;
    ShowPopup(url, xOffset, yOffset, "TRUE", "TRUE", "TRUE");
}

function ShowPopup(divIdORUrlOfContent, xOffset, yOffset, isURL, hideUpperCloseButton, hideLowerCloseButton)
{
    var popupDiv;
    var posXofPopup;
    var posYofPopup;
   ...
   { 
		document.getElementById("_upperCloseButton").style.visibility = "hidden";        
	}
	
	if (hideLowerCloseButton == "TRUE")
	{
		document.getElementById("_lowerCloseButton").style.visibility = "hidden";  
	}
