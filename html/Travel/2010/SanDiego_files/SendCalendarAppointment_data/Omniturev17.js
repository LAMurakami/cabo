...
function s_doPlugins(s) {
	...
	var url=s.linkHandler('alaska.wwte.com','o'); // WWTE LINK
	if(url){
		if(url.indexOf('qscr=cars') >= 0)
		{
			s.c_w("AS_car",'car',expire);
			s.prop16 = s.pageName + " | Cars Link";
		}
		if(url.indexOf('qscr=htwv') >= 0)
		{
			s.c_w("AS_hot",'hotel',expire);
			s.prop16 = s.pageName + " | Hotels Link";
		}
